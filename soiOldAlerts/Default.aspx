            ...
            <table class="style1">
                ...
                <tr>
                    <td style="text-align: left">
                        Find alert<asp:SqlDataSource ID="getGroups" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:SAMStoreConnectionString %>" 
                    
                            
                            
                            SelectCommand="select dbo.alerts.retiretimestamp as created_date, DeviceID as configuration_item, SituationMessage, dbo.alertannotation.createdtime as annotation_created, dbo.alertannotation.createdby, dbo.alertannotation.AnnotationText 
from dbo.alerts LEFT OUTER JOIN dbo.alertannotation on dbo.alerts.alertid = dbo.alertannotation.alertid 
where dbo.alerts.retiretimestamp &gt; GetDate() - 10 and DeviceID LIKE '%' + @ci + '%' Order by created_date DESC
">
							<SelectParameters>
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" height="19px" width="221px"></asp:TextBox>
                ...
                <tr>
                    <td style="text-align: center" colspan="2">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            ...
                            ForeColor="#333333" GridLines="Vertical" Width="544px">
                            <AlternatingRowStyle BackColor="White" />
                            <Columns>
                                <asp:BoundField DataField="created_date" HeaderText="created_date" 
                                    SortExpression="created_date" />
                                <asp:BoundField DataField="configuration_item" HeaderText="configuration_item" 
                                    SortExpression="configuration_item" />
                                <asp:BoundField DataField="SituationMessage" HeaderText="SituationMessage" 
                                    SortExpression="SituationMessage" />
                                <asp:BoundField DataField="annotation_created" HeaderText="annotation_created" 
                                    SortExpression="annotation_created" />
                                <asp:BoundField DataField="createdby" HeaderText="createdby" 
                                    SortExpression="createdby" />
                                <asp:BoundField DataField="AnnotationText" HeaderText="AnnotationText" 
